...
addpath(genpath(fullfile(pwd, 'Q3D_plots_and_stuff/'))); % adds CST stuff to another folder for better organization
...
CST = load('CST_coefficients.mat', 'x');
AC.Wing.Airfoils = [CST.x; CST.x];
